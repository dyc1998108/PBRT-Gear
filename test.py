...
# # 2. This part is used for testing analysis gear(Not available now due to our gear have only utility version)
...
# 3. To simulate a batch, run this part.
...
# 4. To run specific multiple acquisitions in an acquisition, use 'for' loop.
session = fw.lookup('wandell/Graphics test/scenes/suburb')
